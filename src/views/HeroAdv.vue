    ...
    >
      <div class="flex items-center justify-center">
        <div class="px-4 py-6 sm:px-1">
          <h1
            class="font-serif text-3xl font-bold text-center  sm:mt-1 sm:text-auto sm:text-5xl"
          >
            News Advertise
          </h1>
          <p
            class="max-w-lg mt-4 mt-6 text-base font-normal text-center text-gray-500  sm:mt-8 sm:max-w-2xl sm:text-lg"
          >
