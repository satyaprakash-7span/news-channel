  ...
  <div class="relative py-16 mt-12 bg-white sm:mt-32">
    ...
    <div class="mx-auto bg-indigo-600 max-w-7xl lg:bg-transparent lg:px-8">
      <div class="lg:grid lg:grid-cols-12">
        ...
        >
          <div class="absolute h-1/2 bg-gray-50 lg:hidden" aria-hidden="true" />
          <div
        ...
        >
          ...
          >
            ...
            <p class="text-lg text-white">
              ...
              fames. Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Porro vitae totam soluta impedit provident consectetur architecto
              optio placeat, sequi exercitationem in aliquam esse eveniet maxime
              eaque corporis quia voluptates ratione libero a, molestiae illum
              possimus ea quaerat! Voluptatum aliquam ea iure asperiores facilis
              dolorum voluptas at exercitationem, nulla numquam tempora ut
              necessitatibus esse reprehenderit totam magni quisquam, amet sunt.
              Aliquam fugiat illum hic nihil ipsa earum id molestias modi sed
              error delectus incidunt, tempora, ea exercitationem? Magnam error
              mollitia perspiciatis nesciunt facilis minima sint laudantium
              beatae enim ullam. Quos quia debitis earum aspernatur laboriosam
